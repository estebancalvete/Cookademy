...
struct Recipe: Identifiable {
    ...
    // This function will give us the index of the direction excluding the optional directions so we can display the directions properly with their index number
